...
--
-- Class FocusSession as table focus_session
--
...
--
-- Class Pomodoro as table pomodoro
--
...
--
-- Foreign relations for "focus_session" table
--
...
--
-- Foreign relations for "pomodoro" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_flutter_butler', '20260129155707708', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260129155707708', "timestamp" = now();
